...
Namespace Default_MVVM
	Public Class Appearance
        ...
        Private Shared privateDefaultFontFamily As FontFamily
		Public Shared Property DefaultFontFamily() As FontFamily
			Get
				Return privateDefaultFontFamily
			End Get
			Set(ByVal value As FontFamily)
				privateDefaultFontFamily = value
			End Set
		End Property
		Public Sub New()
